...
import { sizeData2_2 } from "../Data";
import { product2_2s } from "../Data";
...
export default function Product2() {
  ...
  const products = product2_2s;
  const sizeData = sizeData2_2;
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ marginBottom: "16px", color: "#333" }}>白色短踢</h1>
