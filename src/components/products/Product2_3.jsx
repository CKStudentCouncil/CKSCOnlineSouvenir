...
import { sizeData2_3 } from "../Data";
import { product2_3s } from "../Data";
...
export default function Product2() {
  ...
  const products = product2_3s;
  const sizeData = sizeData2_3;
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ marginBottom: "16px", color: "#333" }}>黑色短踢</h1>
